...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%lu successful, %ld skipped, timeElasped %.2f)", total - _skippedCount, (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
